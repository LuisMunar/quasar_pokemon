import { PokemonsResponseInterface } from '@/interfaces/pokemon'

export const getPokemonsRepository = (): Promise<PokemonsResponseInterface> => {
...
export const getPokemonRespository = (pokemonUrl: string): Promise<any> => {
  return new Promise((resolve, reject) => {
    resolve({
      "abilities": [
        {
